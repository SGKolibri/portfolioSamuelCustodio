...
class RetroEffectImpl extends Effect {
  constructor() {
    ...
    this.uniforms = uniforms as unknown as Map<string, THREE.Uniform>;
  }
  set colorNum(v: number) {
    (this.uniforms.get("colorNum") as THREE.Uniform<number>).value = v;
  }
  get colorNum(): number {
    return (this.uniforms.get("colorNum") as THREE.Uniform<number>).value;
  }
  set pixelSize(v: number) {
    (this.uniforms.get("pixelSize") as THREE.Uniform<number>).value = v;
  }
  get pixelSize(): number {
    return (this.uniforms.get("pixelSize") as THREE.Uniform<number>).value;
  }
}
